    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                System.out.println("Mensaje recibido a policia: " + mensajeCliente);
                OutputStream os = clienteConectado.getOutputStream();
                DataOutputStream dos = new DataOutputStream(os);
                dos.writeUTF("Un equipo de policias etsa dirigiendose a su localización");
            }
