...
public class Cliente extends Thread {
    ...
    */
    public void gestionarComunicacion (Socket socketCliente) {
        ...
        System.out.println("\t Cliente.Consola " + nombre + " - El cliente construye el objeto " + coche.toString());
        try {
            System.out.println("\t Cliente.Consola " + nombre + " - El cliente envía el objeto al servidor");
            ...
            System.out.println("\t Cliente.Consola " + nombre + " - Objeto recibido del Servidor: " + coche.toString());
            ois.close();
            oos.close();
        } catch (IOException ex) {
            System.out.println(ex.getMessage());
